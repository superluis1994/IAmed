...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2023 a las 20:21:55
...
INSERT INTO `citas_medicas` (`id_cita`, `id_sesion`, `notas`, `fecha_hora`, `status`) VALUES
(1, 1, 'Me duele el estomago, no puedo dormir por la noches pensando en las preocupaciones', '2023-12-06 09:00:00', 1);
...
(2, 'Santa Tecla', 5, '', NULL, '2023-12-06 20:15:45', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `comunidad_medica`
--

CREATE TABLE `comunidad_medica` (
  `id_comunidad` int(11) NOT NULL,
  `nombre_comunidad` varchar(60) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 'Luis', 'Sorto Lemus', 'superluis1994@gmail.com', '503', 5, 2, 'Col. Santa Perez', 2, 466464646, 1, 2, '2023-11-22', '55555555', 1);
...
CREATE TABLE `recordatorios` (
  ...
  `recordarme` varchar(10) NOT NULL,
...
INSERT INTO `recordatorios` (`id_recordatorio`, `titulo`, `descripcion`, `fecha`, `hora`, `recordarme`, `completado`, `id_user`) VALUES
(1, 'Revisar consultas', 'Revisar consultas pendientes y chat con los pacientes', '2023-12-06', '09:00:00', 'on', 1, 1),
(4, 'medicina', 'juela', '2023-12-14', '12:00:00', 'on', 1, 1),
(5, 'medicina', 'Tomar pastillas', '2023-12-22', '12:00:00', 'off', 1, 1);
...
--
-- Estructura de tabla para la tabla `sector_salud`
--
...
INSERT INTO `sesiones` (`id_sesion`, `id_user`, `id_afiliado`, `fecha_registro`) VALUES
(1, 2, 1, '2023-12-05');
...
INSERT INTO `sexos` (`id_sex`, `nombre`, `status`) VALUES
(1, 'Hombre', 1),
(2, 'Mujer', 1);
...
INSERT INTO `tipo_suscripcion` (`id_tipo_suscripcion`, `nombre_suscripcion`, `precio`, `tipo_usuario`) VALUES
(1, 'basica', 0.00, 2),
(2, 'standard', 100.00, 2),
(3, 'pro', 150.00, 2),
(4, 'basica', 0.00, 1),
...
(1, 'paulcartagena', 'sorto', 'superluis1994@gmail.com', 2, 1, '', '', '2023-11-01', '2023-11-01', 0),
...
ALTER TABLE `afiliado_especialidades`
  ...
  ADD KEY `fk_afil_espcia` (`id_afiliado`),
  ADD KEY `fk_espcialidad` (`id_especialidad`);
...
ALTER TABLE `citas_medicas`
  ...
  ADD KEY `fk_sesion_citas` (`id_sesion`);
...
--
-- Indices de la tabla `comunidad_medica`
--
ALTER TABLE `comunidad_medica`
...
ALTER TABLE `datos_personales`
  ...
  ADD KEY `fk_datos_personales_user` (`id_user`);
...
ALTER TABLE `horarios_medico`
  ...
  ADD KEY `Fk_horario_afiliados` (`id_afiliado`);
...
ALTER TABLE `perfil_afiliado`
  ...
  ADD KEY `fk_perfil_afiliado` (`id_datos`);
...
ALTER TABLE `recordatorios`
  ...
  ADD KEY `fk_recordatorios` (`id_user`);
...
--
-- Indices de la tabla `sector_salud`
--
ALTER TABLE `sector_salud`
  ADD PRIMARY KEY (`id_sector_publico`),
  ADD KEY `fk_sector_salud` (`id_comuni`);
...
ALTER TABLE `sesiones`
  ...
  ADD KEY `fk_paciente` (`id_user`),
  ADD KEY `fk_afiliado` (`id_afiliado`);
...
ALTER TABLE `suscripciones`
  ...
  ADD KEY `fk_user_suscripcion` (`id_user`),
  ADD KEY `fk_tipo_suscripcion` (`id_tipoSuscripcion`);
...
--
-- AUTO_INCREMENT de la tabla `comunidad_medica`
--
ALTER TABLE `comunidad_medica`
...
--
-- AUTO_INCREMENT de la tabla `sector_salud`
--
ALTER TABLE `sector_salud`
...
--
-- Filtros para la tabla `afiliado_especialidades`
--
ALTER TABLE `afiliado_especialidades`
  ADD CONSTRAINT `fk_afil_espcia` FOREIGN KEY (`id_afiliado`) REFERENCES `perfil_afiliado` (`id_afiliado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_espcialidad` FOREIGN KEY (`id_especialidad`) REFERENCES `especialidades` (`id_especialidad`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `citas_medicas`
--
ALTER TABLE `citas_medicas`
  ADD CONSTRAINT `fk_sesion_citas` FOREIGN KEY (`id_sesion`) REFERENCES `sesiones` (`id_sesion`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datos_personales`
--
ALTER TABLE `datos_personales`
  ADD CONSTRAINT `fk_ciudad` FOREIGN KEY (`ciudad`) REFERENCES `ciudad` (`codigo_ciudad`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_datos_personales_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estado` FOREIGN KEY (`estado`) REFERENCES `estados` (`codigo_estado`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pais` FOREIGN KEY (`pais`) REFERENCES `pais` (`codigo_pais`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `horarios_medico`
--
ALTER TABLE `horarios_medico`
  ADD CONSTRAINT `Fk_horario_afiliados` FOREIGN KEY (`id_afiliado`) REFERENCES `perfil_afiliado` (`id_afiliado`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `perfil_afiliado`
--
ALTER TABLE `perfil_afiliado`
  ADD CONSTRAINT `fk_perfil_afiliado` FOREIGN KEY (`id_datos`) REFERENCES `datos_personales` (`id_datos`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `recordatorios`
--
ALTER TABLE `recordatorios`
  ADD CONSTRAINT `fk_recordatorios` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `sector_salud`
--
ALTER TABLE `sector_salud`
  ADD CONSTRAINT `fk_sector_salud` FOREIGN KEY (`id_comuni`) REFERENCES `comunidad_medica` (`id_comunidad`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `sesiones`
--
ALTER TABLE `sesiones`
  ADD CONSTRAINT `fk_afiliado` FOREIGN KEY (`id_afiliado`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_paciente` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `suscripciones`
--
ALTER TABLE `suscripciones`
  ADD CONSTRAINT `fk_tipo_suscripcion` FOREIGN KEY (`id_tipoSuscripcion`) REFERENCES `tipo_suscripcion` (`id_tipo_suscripcion`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_user_suscripcion` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_rol` FOREIGN KEY (`rol`) REFERENCES `roles` (`id_rol`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_status` FOREIGN KEY (`status`) REFERENCES `status` (`id_status`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
