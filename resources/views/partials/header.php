...
<head>
  ...
  <title>Dashboard - IAmed</title>

  <link rel="shortcut icon" href="<?=$utils->assets('assets/compiled/svg/favicon.svg') ?>" type="image/x-icon" />
  ...
  <link rel="stylesheet" href="<?=$utils->assets('assets/compiled/css/ui-widgets-chatbox.css') ?>" />
