    ...
    <div id="app">
      <div id="sidebar">
        ...
        <?php require_once($_SESSION['datosUser']['rol']."Menu.php"); ?>
        <!-- fin del menu -->
        </div>
      </div>
                ...
                <div class="dropdown">
                  <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="user-menu d-flex">
                      <div class="user-name text-end me-3">
                        ...
                        <p class="mb-0 text-sm text-gray-600"><?php echo @$_SESSION['datosUser']['rol']; ?></p>
                      </div>
                      <div class="user-img d-flex align-items-center">
                        <div class="avatar avatar-md">
                          <img src="<?=$utils->assets("img/team-1.jpg");?>" />
                        </div>
                      </div>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem">
                    ...
                    <li>
                      ...
                      <a class="dropdown-item" href="#"><i class="icon-mid bi bi-wallet me-2"></i> Cartera</a>
