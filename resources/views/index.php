...
<body>
        ...
        <div class="container pb-2">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        <h5 class="text-white mb-0">Celular</h5>
                        <span>+503 7580-2763</span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="row g-0">
                        <div class="col-6">
                            <img class="img-fluid" src="<?=$utils->assets('img/about-1.jpg')?>">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="<?=$utils->assets('img/about-2.jpg')?>">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="<?=$utils->assets('img/about-3.jpg')?>">
                        </div>
                        <div class="col-6">
    ...
    <script src="<?=$utils->assets('lib/wow/wow.min.js')?>"></script>
    <script src="<?=$utils->assets('lib/easing/easing.min.js')?>"></script>
    <script src="<?=$utils->assets('lib/waypoints/waypoints.min.js')?>"></script>
    <script src="<?=$utils->assets('lib/counterup/counterup.min.js')?>"></script>
    <script src="<?=$utils->assets('lib/owlcarousel/owl.carousel.min.js')?>"></script>

    <!-- Template Javascript -->
    <script src="<?=$utils->assets('js/main.js')?>"></script>
</body>
